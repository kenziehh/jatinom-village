    ...
    <section className="container py-10 md:py-20">
      <div className="flex flex-col gap-8 md:gap-16">
        <div className="flex flex-col gap-4 md:flex-row md:justify-between">
          <h2 className="font-semibold text-5xl">Peta Desa</h2>

          <a
            href="https://maps.app.goo.gl/3zRGHsUTbhww3yaq5"
            target="_blank"
          >
            <div className="bg-dark-green rounded-[20px] text-white py-2 px-4">
              Lihat di Google Maps
            </div>
          </a>
        </div>
        <iframe
          className="w-full h-[50vh] md:h-[75vh] rounded-2xl"
