...
const PotensiCard = ({ title, desc, img }) => {
  return (
    <div className="bg-dark-green text-white flex flex-col gap-4 md:gap-8 pb-4 md:pb-8 rounded-[20px] hover:scale-105">
      <img src={img} alt={title} className="rounded-t-[20px] h-56 md:h-80" />
